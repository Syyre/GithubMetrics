...
export type StorageHash =
  StorageHashBase<'c0cab8f1ce9d6f9b2066ab6347d514e48c6ce334d39691f963bb1fc06d2b2e03'>;
export type ExecutionHash =
  ExecutionHashBase<'539e85c3c73571c2ddf843883c5f094ea6d807a2466b96088b2c47195d2b271b'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly RepositoryLanguage: {
      ...
      readonly repositoryId: CodecTypes['pg/int4@1']['output'];
      readonly CreatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly UpdatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    readonly User: {
      ...
      readonly commits_last_30_days: CodecTypes['pg/int4@1']['output'];
      readonly account_created_at: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly email: CodecTypes['pg/text@1']['output'] | null;
      readonly repositoriesUpdatedAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
      readonly CreatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly UpdatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
  };
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly RepositoryLanguage: {
      ...
      readonly repositoryId: CodecTypes['pg/int4@1']['input'];
      readonly CreatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly UpdatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly User: {
      ...
      readonly commits_last_30_days: CodecTypes['pg/int4@1']['input'];
      readonly account_created_at: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly email: CodecTypes['pg/text@1']['input'] | null;
      readonly repositoriesUpdatedAt: CodecTypes['pg/timestamptz-string@1']['input'] | null;
      readonly CreatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly UpdatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
  };
...
export namespace Models {
  export type public_User = {
    ...
    commits_last_30_days: CodecTypes['pg/int4@1']['output'];
    account_created_at: CodecTypes['pg/timestamptz-string@1']['output'];
    email: CodecTypes['pg/text@1']['output'] | null;
    repositoriesUpdatedAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
  ...
  export type public_Repository = {
    ...
    CreatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    UpdatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    languages: public_RepositoryLanguage[];
    owner: public_User;
    readonly [RelationKeys]?: 'languages' | 'owner';
  };
  export type public_RepositoryLanguage = {
    language: CodecTypes['pg/text@1']['output'];
    bytes: CodecTypes['pg/int4@1']['output'];
    repositoryId: CodecTypes['pg/int4@1']['output'];
    CreatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    UpdatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    repository: public_Repository;
    readonly [RelationKeys]?: 'repository';
  };
}
...
export declare const models: {
  public: {
    ...
    RepositoryLanguage: Models.public_RepositoryLanguage;
  };
};
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly repositoryLanguage: {
              ...
              primaryKey: { readonly columns: readonly ['language', 'repositoryId'] };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'repositoryLanguage_repositoryId_idx_dce7a8ba';
                  readonly prefix: 'repositoryLanguage_repositoryId_idx';
                  readonly columns: readonly ['repositoryId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'repositoryLanguage';
                    readonly columns: readonly ['repositoryId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly user: {
              columns: {
                ...
                readonly repositoriesUpdatedAt: {
                  readonly nativeType: 'timestamptz';
                  readonly codecId: 'pg/timestamptz-string@1';
                  readonly nullable: true;
                };
...
> & {
  ...
  readonly roots: {
    ...
    readonly repositoryLanguage: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'RepositoryLanguage';
    };
  };
  readonly domain: {
    readonly namespaces: {
            ...
            readonly relations: {
              readonly languages: {
                ...
                readonly on: {
                  ...
                  readonly targetFields: readonly ['repositoryId'];
                };
              };
              readonly owner: {
          ...
          readonly RepositoryLanguage: {
            ...
            readonly relations: {
              readonly repository: {
                ...
                readonly nullable: false;
                readonly on: {
                  readonly localFields: readonly ['repositoryId'];
                  readonly targetFields: readonly ['id'];
                };
              };
            };
            readonly storage: {
              readonly table: 'repositoryLanguage';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly language: { readonly column: 'language' };
                readonly bytes: { readonly column: 'bytes' };
                readonly repositoryId: { readonly column: 'repositoryId' };
                readonly CreatedAt: { readonly column: 'CreatedAt' };
                readonly UpdatedAt: { readonly column: 'UpdatedAt' };
              };
            };
          ...
          readonly User: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly commits_last_30_days: { readonly column: 'commits_last_30_days' };
                readonly account_created_at: { readonly column: 'account_created_at' };
                readonly email: { readonly column: 'email' };
                readonly repositoriesUpdatedAt: { readonly column: 'repositoriesUpdatedAt' };
                readonly CreatedAt: { readonly column: 'CreatedAt' };
                readonly UpdatedAt: { readonly column: 'UpdatedAt' };
              };
            };
